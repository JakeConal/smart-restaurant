...
export const authApi = {
  ...
  customerSignup: (data: { email: string; password: string; firstName: string; lastName: string }) =>
...
export const profileApi = {
  ...
  updateProfile: (authToken: string, data: {
    firstName?: string;
    lastName?: string;
    phoneNumber?: string;
    dateOfBirth?: string;
  ...
  updatePassword: (authToken: string, data: {
...
export const orderApi = {
  createOrder: (authToken: string | null, data: {
    tableId: string;
    items: Array<{
      menuItemId: string;
      quantity: number;
...
// Reviews API (placeholder - would need backend implementation)
export const reviewApi = {
  getItemReviews: (menuItemId: string) =>
    apiRequest(`/api/reviews/item/${menuItemId}`),

  createReview: (authToken: string, data: {
    menuItemId: string;
    orderId: string;
    rating: number;
    comment?: string;
